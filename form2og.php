...
$idiomas = ["Español","English","Deustch"];
    ...
    <div>
        <form method="POST" action="">
            ...
            <?php foreach ($musicas as $msc) : ?>
                ...
                <?php echo $msc; ?>
                <input type="radio" class=<?php echo (isset($errores['musica']) )?"rojo":""?> name="musica" value="<?php strtolower($msc) ?>">
            </div>
            <?php endforeach; ?>
            ...
            <div class="form-group">
                Rock
                <input type="radio" class=<?php echo (isset($errores['musica']) )?"rojo":""?> name="musica" value="rock">
            </div>
            <div class="form-group">
                Pop
                <input type="radio" class=<?php echo (isset($errores['musica']) )?"rojo":""?> name="musica" value="pop">
            </div>
            <div class="form-group">
                Jazz
                <input type="radio" class=<?php echo (isset($errores['musica']) )?"rojo":""?> name="musica" value="jazz">
            </div>
            ...
            <div class="form-group">
                Fútbol
                <input type="checkbox" name="pasatiempo[]" value="futbol">
            </div>
            <div class="form-group">
                Tenis
                <input type="checkbox" name="pasatiempo[]" value="tenis">
            </div>
            <div class="form-group">
                Natación
                <input type="checkbox" name="pasatiempo[]" value="natacion">
            </div>
